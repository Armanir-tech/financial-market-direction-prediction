...
from src.reporting import save_metric_plots, save_price_plots, write_final_report
...
def main() -> None:
    ...
    classical_metrics = evaluate_classical_models(feature_table)
    lstm_metrics = evaluate_lstm(feature_table)
